...
Розмір послідовності: {len(original_sequence) * 16} bits\n
Ентропія: {entropy}\n \n
_____________Кодування_RLE_____________\n
Закодована RLE послідовність: {encoded_rle}\n
Розмір закодованої RLE послідовності: {len(encoded_rle) * 16} bits\n
...
_____________Кодування_LZW_____________\n
___________Поетапне кодування__________\n""")
...
Закодована LZW послідовність:{''.join(map(str, result))} \n
Розмір закодованої LZW послідовності: {size} bits \n
Коефіцієнт стиснення LZW: {cr_lzv}\n""")
...
Розмір декодованої LZW послідовності: {len(result) * 16} bits\n \n" + "_" * 100 + "\n \n""")
